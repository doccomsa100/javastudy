...
public class StudentTest1 {
	...
	public static void main(String[] args) {
		...
		- Stack Area : 
		메서드 안에 변수및매개변수를 선언하면 , 메서드가 실행이 될때 변수또는 매개변수의 이영역에 기억장소가 생성.
		...
		*/
		...
		//기본데이타타입 8 정수형: byte, short, int, long 실수형: float, double 논리형: boolean
		//기본데이타타입을 이용하여 메서드안에서 변수를 선언하면, 기억장소는 스택영역에 생성한다.
